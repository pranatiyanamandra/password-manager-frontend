...
import { setTokenActionCreator } from "../../actions";
const Logout = (props) => {
    ...
    const renderModalContent = () => {
        return <>
            ...
            <div className="my-container">
                <h5 style={{ margin: "auto" }}><b>Are you sure you want to Logout? </b></h5>
                <div class="container" style={{marginTop:"5%"}}>
                    <div class="row">
                        <div class="col-sm">
                            <button className="btn btn-outline-light"
                                type="submit"
                                onClick={(event) => closeLoginModal(event)}
                            >No</button>    </div>
                        <div class="col-sm">
                        </div>
                        <div class="col-sm">
                            <button className="btn btn-outline-light"
                                type="submit"
                                onClick={(event) => onYesClick(event)}
                            >Yes</button>    </div>
                    </div>
                </div>
